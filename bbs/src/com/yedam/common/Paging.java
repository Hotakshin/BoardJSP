...
public class Paging {
	...
	public String toString() {
		return "Paging [pageSize=" + pageSize + ", firstPageNo=" + firstPageNo + ", prevPageNo=" + prevPageNo
				...
				+ nextPageNo + ", finalPageNo=" + finalPageNo + ", totalCount=" + totalCount + ", getPageSize()="
				+ getPageSize() + ", getFirstPageNo()=" + getFirstPageNo() + ", getPrevPageNo()=" + getPrevPageNo()
				+ ", getStartPageNo()=" + getStartPageNo() + ", getPageNo()=" + getPageNo() + ", getEndPageNo()="
				+ getEndPageNo() + ", getNextPageNo()=" + getNextPageNo() + ", getFinalPageNo()=" + getFinalPageNo()
				+ ", getTotalCount()=" + getTotalCount() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
